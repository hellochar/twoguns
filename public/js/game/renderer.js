define(['b2'], function(b2) {

    function Renderer(viewportWidth) {
        this.viewportWidth = viewportWidth;
        this.center = new b2.Vec2; //world coordinates

        //setup debug draw
        this.debugDraw = new b2.DebugDraw();
        this.debugDraw.SetFlags(b2.DebugDraw.e_shapeBit | b2.DebugDraw.e_jointBit);
    }
